...
export {
  ...
  redrawIsolatingDevicesForViewMode,
  redrawDampingDevicesForViewMode,
  redrawFrameDampingDevicesForViewMode,
...
export {
  ...
  setBeamViewMode,
  setBraceViewMode,
  setIsolatingDeviceViewMode,
  setDampingDeviceViewMode,
  setFrameDampingDeviceViewMode,
  setPileViewMode,
  setFootingViewMode,
