...
const EQUIVALENCE_CONFIG = {
  ...
  materialCompatibility: {
    SS400: ['SS400'],
    SN400: ['SN400', 'SN400A', 'SN400B', 'SN400C'],
    SN490: ['SN490', 'SN490A', 'SN490B', 'SN490C'],
    SM490: ['SM490'],
    SS540: ['SS540'],
    // コンクリート
    FC18: ['FC18'],
...
function checkSectionType(normA, normB) {
  ...
  return {
    ...
    passed: isCompatible,
    details: isCompatible ? `Compatible: ${typeA} ≈ ${typeB}` : `Incompatible: ${typeA} ≠ ${typeB}`,
  };
}
...
function checkMaterial(normA, normB) {
  ...
  return {
    ...
    passed: isCompatible,
    details: isCompatible ? `Compatible: ${matA} ≈ ${matB}` : `Incompatible: ${matA} ≠ ${matB}`,
  };
}
 ...
 */
function extractDimensions(sectionData, _elementType) {
