 ...
 * - ST-Bridge固有の命名規則も網羅
 *
 * @module common/stb/data/attributeKeys
 */
 ...
 * - 標準: radius
 * - ST-Bridge: R, r
 * - 角部: corner_radius, R1, R2
 *
 * @type {ReadonlyArray<string>}
 */
export const RADIUS_KEYS = Object.freeze([
  'radius', // 標準形式
  'Radius', // 大文字開始
  'R', // 記号形式
  'r', // 小文字
  'R1', // 角部R1
  'R2', // 角部R2
  'corner_radius', // コーナー半径
  'fillet_radius', // フィレット半径
]);
 ...
 * @type {ReadonlyArray<string>}
 */
export const LENGTH_KEYS = Object.freeze([
  'length', // 標準形式
  'Length', // 大文字開始
  'L', // 記号形式
  'l', // 小文字
