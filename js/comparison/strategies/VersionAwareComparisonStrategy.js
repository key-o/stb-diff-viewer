...
import { ComparisonStrategy, BasicComparisonStrategy } from './ComparisonStrategy.js';
import {
 ...
 * バージョン対応比較戦略
 */
export class VersionAwareComparisonStrategy extends ComparisonStrategy {
  /**
...
// デフォルトインスタンス
export const versionAwareStrategy = new VersionAwareComparisonStrategy();
